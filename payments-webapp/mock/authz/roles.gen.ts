...
export const mockRoles: readonly { readonly name: string; readonly grants: readonly string[] }[] = [
  { name: "Merchant", grants: ["bank-accounts:manage", "merchants:read", "merchants:update", "payment-requests:create", "payment-requests:read", "payouts:create", "payouts:read", "refunds:create", "transactions:read"] },
  { name: "PlatformAdmin", grants: ["merchants:read-all", "payment-requests:read-all", "payouts:read-all", "transactions:read-all"] },
];
